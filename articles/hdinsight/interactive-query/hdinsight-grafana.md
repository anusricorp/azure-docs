...
Currently, in Azure HDInsight, Grafana is supported with the Hbase, Kafka and Interactive Query cluster types. It is not supported for Active Directory domain users with Enterprise Security Pack enabled clusters.
